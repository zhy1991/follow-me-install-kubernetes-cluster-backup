...
stream {
    upstream backend {
        ...
        server 192.168.31.54:6443        max_fails=3 fail_timeout=30s;
        server 192.168.31.55:6443        max_fails=3 fail_timeout=30s;
        server 192.168.31.56:6443        max_fails=3 fail_timeout=30s;
    }
