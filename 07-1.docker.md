...
确认各 worker 节点的 docker0 网桥和 flannel.1 接口的 IP 处于同一个网段中(如下 172.30.144.0/32 位于 172.30.144.1/21 中)：
...
4: docker0: <NO-CARRIER,BROADCAST,MULTICAST,UP> mtu 1500 qdisc noqueue state DOWN group default 
    link/ether 02:42:64:a0:a8:7f brd ff:ff:ff:ff:ff:ff
    inet 172.30.144.1/21 brd 172.30.151.255 scope global docker0
       valid_lft forever preferred_lft forever
```
