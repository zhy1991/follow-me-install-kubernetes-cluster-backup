...
注意：如果没有特殊指明，本文档的所有操作**均在 k8s-dev-master01-54 节点上执行**。
...
1. 通过 kube-apiserver 或 kubectl proxy 访问：
    ...
    https://192.168.31.54:6443/apis/metrics.k8s.io/v1beta1/nodes
    https://192.168.31.54:6443/apis/metrics.k8s.io/v1beta1/nodes/<node-name>
    https://192.168.31.54:6443/apis/metrics.k8s.io/v1beta1/pods
    https://192.168.31.54:6443/apis/metrics.k8s.io/v1beta1/namespace/<namespace-name>/pods/<pod-name>
  ...
  "items": [
    {
      "metadata": {
        "name": "192.168.31.59",
        "selfLink": "/apis/metrics.k8s.io/v1beta1/nodes/192.168.31.59",
        "creationTimestamp": "2019-10-09T08:47:21Z"
      },
      "timestamp": "2019-10-09T08:47:08Z",
      "window": "30s",
      "usage": {
        "cpu": "503223175n",
        "memory": "1235200Ki"
    ...
    },
    {
      "metadata": {
        "name": "192.168.31.58",
        "selfLink": "/apis/metrics.k8s.io/v1beta1/nodes/192.168.31.58",
        "creationTimestamp": "2019-10-09T08:47:21Z"
      },
      "timestamp": "2019-10-09T08:47:11Z",
      "window": "30s",
      "usage": {
        "cpu": "474172578n",
        "memory": "1248424Ki"
    ...
    },
    {
      "metadata": {
        "name": "192.168.31.57",
        "selfLink": "/apis/metrics.k8s.io/v1beta1/nodes/192.168.31.57",
        "creationTimestamp": "2019-10-09T08:47:21Z"
      },
      "timestamp": "2019-10-09T08:47:08Z",
      "window": "30s",
    ...
    },
    {
      "metadata": {
        "name": "192.168.31.54",
        "selfLink": "/apis/metrics.k8s.io/v1beta1/nodes/192.168.31.54",
        "creationTimestamp": "2019-10-09T08:47:21Z"
      },
      "timestamp": "2019-10-09T08:47:15Z",
      "window": "30s",
      "usage": {
        "cpu": "764802964n",
        "memory": "4751736Ki"
    ...
    },
    {
      "metadata": {
        "name": "192.168.31.55",
        "selfLink": "/apis/metrics.k8s.io/v1beta1/nodes/192.168.31.55",
        "creationTimestamp": "2019-10-09T08:47:21Z"
      },
      "timestamp": "2019-10-09T08:47:15Z",
      "window": "30s",
    ...
    },
    {
      "metadata": {
        "name": "192.168.31.56",
        "selfLink": "/apis/metrics.k8s.io/v1beta1/nodes/192.168.31.56",
        "creationTimestamp": "2019-10-09T08:47:21Z"
      },
      "timestamp": "2019-10-09T08:47:08Z",
      "window": "30s",
...
192.168.31.54   754m         18%    4639Mi          58%       
192.168.31.55   853m         21%    1923Mi          24%       
192.168.31.56   829m         20%    1911Mi          24%       
192.168.31.57   269m         3%     1220Mi          7%        
192.168.31.58   389m         4%     1221Mi          7%        
192.168.31.59   518m         6%     1206Mi          7%
```
