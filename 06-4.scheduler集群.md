...
tcp        0      0 192.168.31.54:10251    0.0.0.0:*               LISTEN      114702/kube-schedul
tcp        0      0 192.168.31.54:10259    0.0.0.0:*               LISTEN      114702/kube-schedul
```

``` bash
$ curl -s http://192.168.31.54:10251/metrics |head
...
``` bash
$ curl -s --cacert /opt/k8s/work/ca.pem --cert /opt/k8s/work/admin.pem --key /opt/k8s/work/admin-key.pem https://192.168.31.54:10259/metrics |head
# HELP apiserver_audit_event_total Counter of audit events generated and sent to the audit backend.
# TYPE apiserver_audit_event_total counter
apiserver_audit_event_total 0
# HELP apiserver_audit_requests_rejected_total Counter of apiserver requests rejected due to an error in audit logging backend.
...
metadata:
  annotations:
    control-plane.alpha.kubernetes.io/leader: '{"holderIdentity":"k8s-dev-master01-54_369cf38f-e990-11e9-bea5-005056877ecb","leaseDurationSeconds":15,"acquireTime":"2019-05-26T03:06:39Z","renewTime":"2019-05-26T03:09:39Z","leaderTransitions":5}'
...
可见，当前的 leader 为 k8s-dev-master01-54 节点。
